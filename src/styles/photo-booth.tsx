...
export const styleBooth = css`
  * {
  ...
  .paypal-form a::after {
    content: "Support me with a donation!";
    position: absolute;
    bottom: 125%;
    left: 50%;
  ...
  button:not(:disabled):hover {
    background: linear-gradient(135deg, #ffc0cb, #ea909f);
    color: white;
  }
